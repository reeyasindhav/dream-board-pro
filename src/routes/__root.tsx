  ...
  head: () => ({
    meta: [
      ...
      { title: "Dreamboard — Vision boards that turn into progress" },
      {
        name: "description",
        content:
          "Drag-and-drop vision boards, milestone tracking and a mood journal in one calm space for personal growth.",
      },
      { name: "author", content: "Dreamboard" },
      { property: "og:title", content: "Dreamboard — Vision boards that turn into progress" },
      {
        property: "og:description",
        content: "Creative visualisation meets structured execution.",
      },
